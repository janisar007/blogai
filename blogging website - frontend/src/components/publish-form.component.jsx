...
const PublishForm = () => {
  ...
  const publishBlog = (e) => {
    ...
    if (!des || !des.length || des.length > characterLimit) {
      return toast.error(
        `Write a description within ${characterLimit} characters.`
      );
    }
      ...
      <section className="w-screen max-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
        ...
        <div className="border-grey lg:border-1 lg:pl-8">
          ...
          <input
            ...
            defaultValue={title}
            onChange={hanldeBlogTitleChange}
          />
          ...
          <p className="mt-1 text-dark-grey text-sm text-right">
            {characterLimit - des.length} charcters left
          </p>
          <p className="text-dark-grey mb-2 mt-9">
          ...
          <div className="relative input-box pl-2 py-2 pb-4">
            <input
              type="text"
              placeholder="Topic"
              className="sticky input-box bh-white top-0 left-0 pl-4 mb-3 focus:bg-white"
